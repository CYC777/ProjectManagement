class ArtifactsController < ApplicationController
  ...
  def new
    ...
    @artifact.workproject_id = params[:workproject_id]
  end
  ...
  def create
    ...
    respond_to do |format|
      if @artifact.save
        format.html { redirect_to tenant_workproject_url(tenant_id: Tenant.current_tenant_id, 
        id: @artifact.workproject_id), notice: 'Artifact was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tenant_workproject_url(tenant_id: Tenant.current_tenant_id, 
      id: @artifact.workproject_id), notice: 'Artifact was successfully destroyed.' }
  ...
  private
    ...
    def artifact_params
      params.require(:artifact).permit(:name, :workproject_id, :upload)
    end
end
