...
ActiveRecord::Schema.define(version: 20170924001229) do
  ...
  create_table "artifacts", force: :cascade do |t|
    t.string   "name"
    t.string   "key"
    t.integer  "workproject_id"
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
  end

  add_index "artifacts", ["workproject_id"], name: "index_artifacts_on_workproject_id", using: :btree
  ...
  create_table "workprojects", force: :cascade do |t|
    t.string   "title"
    t.string   "details"
  ...
  add_index "workprojects", ["tenant_id"], name: "index_workprojects_on_tenant_id", using: :btree

  add_foreign_key "artifacts", "workprojects"
  add_foreign_key "members", "tenants"
  add_foreign_key "members", "users"
  add_foreign_key "tenants", "tenants"
  add_foreign_key "workprojects", "tenants"
end
