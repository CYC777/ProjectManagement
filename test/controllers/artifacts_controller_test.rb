...
class ArtifactsControllerTest < ActionController::TestCase
  ...
  test "should create artifact" do
    assert_difference('Artifact.count') do
      post :create, artifact: { key: @artifact.key, name: @artifact.name, workproject_id: @artifact.workproject_id }
    end
  ...
  test "should update artifact" do
    patch :update, id: @artifact, artifact: { key: @artifact.key, name: @artifact.name, workproject_id: @artifact.workproject_id }
    assert_redirected_to artifact_path(assigns(:artifact))
  end
